...
part5.file.for.report <- config.args$analysis$part5$part5_report_stuff_filename
part5.file.report.path <- file.path(r.obj.loc, part5.file.for.report)

ggplot.directory <- file.path(r.obj.loc, config.args$analysis$part5$ggplot_dir)
marker.gene.dir <- file.path(r.obj.loc, config.args$analysis$part5$marker_gene_dir)
