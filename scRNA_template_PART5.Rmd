...
part5.file.for.report <- sub(".RDS", paste0(part5.suffix, ".RData"), part5.file.for.report )
part5.file.report.path <- file.path(r.obj.loc, part5.file.for.report)

ggplot.directory.name <- config.args$analysis$part5$ggplot_dir
ggplot.directory.name <- paste0(ggplot.directory.name, part5.suffix)
...
```{r gene_feature, warning=FALSE,error=FALSE,message=FALSE, fig.width = 25, fig.height = 20}
