...
r.obj.loc <- "/projects/b1012/xvault/PROJECTS/Illumina/LePoole01_10X/pipeline_testing_rds/"
organism="human"
set.seed(12345)

mito.cutoff = 35
RNA.count.floor = 1000
RNA.count.ceiling = 30000
feature.count.ceiling = 10000
feature.count.floor = 700
rbc.cutoff <- 100
ribo.cutoff <- 0
...
save(list = to.save.for.report, file=paste0(r.obj.loc, "part2_stuff_for_report.RData"))
```
