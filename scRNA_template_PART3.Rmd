...
run.cell.cycle <- config.args$project$run_cell_cycle
...
```{r cellcycle, warning=FALSE, error=FALSE, eval = run.cell.cycle}
...
```{r cellcycle_table, warning=FALSE, error=FALSE, message=FALSE, eval = run.cell.cycle}
...
```{r scale_data_cell_cycle, warning=FALSE, error=FALSE, message=FALSE, eval=run.cell.cycle}
