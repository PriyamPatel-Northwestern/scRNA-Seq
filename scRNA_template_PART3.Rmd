...
params:
  config.args: "./config_sctransform_single_sample.yaml"
---
...
experiment.split <- lapply(X = experiment.split, FUN = function(single.seurat.object) { 
  if (!run.sctransform){
    ...
    single.seurat.object <- ScaleData(single.seurat.object, vars.to.regress = regression.vars)
    single.seurat.object
  } else {
    single.seurat.object <- experiment.split$BM_WT
