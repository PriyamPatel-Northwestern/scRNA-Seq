...
```{r cellcycle, warning=FALSE,error=FALSE}
...
```{r scale_data_cell_cycle, warning=FALSE,error=FALSE,message=FALSE}
...
pca.loadings1.filename <- paste0("part3", part3.suffix, "_pca_loadings1.png")
pca.loadings2.filename <- paste0("part3", part3.suffix, "_pca_loadings2.png")

pca.loadings.1.path <- file.path(r.obj.loc, pca.loadings1.filename)
pca.loadings.2.path <- file.path(r.obj.loc, pca.loadings2.filename)

pca.loadings.1
pca.loadings.2

ggsave(pca.loadings.1.path, 
       pca.loadings.1)

ggsave(pca.loadings.2.path, 
       pca.loadings.2)
```
...
pca.plot.filename <- paste0("part3", part3.suffix, "_pca_plot.png")
pca.plot.path <- file.path(r.obj.loc, pca.plot.filename)

pca.plot
ggsave(pca.plot.path, pca.plot)
```
...
elbow.plot.filename <- paste0("part3", part3.suffix, "_elbow_plot.png")
elbow.plot.path <- file.path(r.obj.loc, elbow.plot.filename)

elbow.plot

ggsave(elbow.plot.path,
       elbow.plot)
```
