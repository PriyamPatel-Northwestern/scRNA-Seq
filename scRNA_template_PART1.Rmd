...
Small RNA-seq library preparation: miRNA library from clinical samples. Each sample contains1.5 ug (1500 ng) of isolated and purified RNA (DNASE treated).
Two groups should exist with the label being blinded.
...
```{r user_vals, warning=FALSE,error=FALSE, message=FALSE, eval=FALSE, echo = FALSE}
# TODO
experiment_name = "Abdulkadir08" 
...
dataset_loc <- "/projects/b1012/xvault/PROJECTS/Illumina/Abdulkadir08/Matrix/" # path containing the folders containing the raw_feature_bc_matrix.h5 files
...
r.obj.loc <- "/projects/b1012/xvault/PROJECTS/Illumina/Abdulkadir08/rds/" # Output folder

ids <- c("CTL", "MYCi") # sample names, need to match the folders containing the h5 files
```


<!-- uncomment for testing -->
<!-- ```{r exp_setup_testing, warning=FALSE,error=FALSE, message=FALSE} -->
<!-- experiment_name = "Bonini07" -->
<!-- # dataset_loc <- "/Volumes/My_Passport_for_Mac/tenX_projects/Bonini05/Data/" -->
<!-- dataset_loc <- "/Users/brianwray/Desktop/Projects/Bonini07/matrix_data" -->
<!-- r.obj.loc <- "/Users/brianwray/Desktop/Projects/Bonini07/rds" -->
<!-- organism = "mouse" -->
...
```{r load_data_hdf5, warning=FALSE,error=FALSE, message=FALSE, eval=FALSE}
...
experiment.aggregate$percent.rbc <- PercentageFeatureSet(experiment.aggregate, pattern = c(HBA.marker, HBB.marker))
summary(experiment.aggregate$percent.rbc)
```

```{r calculate_pct_ribo, warning=FALSE,error=FALSE, message=FALSE}
experiment.aggregate$percent.ribo <- PercentageFeatureSet(experiment.aggregate, pattern = c(RBL.marker, RPS.marker))
...
```{r violins, warning=FALSE,error=FALSE,message=FALSE, fig.height=4}
VlnPlot(
  experiment.aggregate,
...
FeatureScatter(experiment.aggregate, feature1 = "nFeature_RNA", feature2 = "percent.mito") 
FeatureScatter( experiment.aggregate, "nCount_RNA", "nFeature_RNA", pt.size = 0.5) 
```
